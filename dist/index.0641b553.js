...
var _getNewsApi = require("./js/get-news-api");
var _makeQueryWord = require("./js/make-query-word");

},{"./js/get-news-api":"6SsCS","./js/make-query-word":"YkYTq"}],"6SsCS":[function(require,module,exports,__globalThis) {
...
},{}],"YkYTq":[function(require,module,exports,__globalThis) {
var _getNewsApi = require("./get-news-api");
...
const makeQuery = ()=>{
    ...
    form.addEventListener('submit', (e)=>{
        ...
        (0, _getNewsApi.getNews)(keyword);
    });
    return keyword;
};

},{"./get-news-api":"6SsCS"}]},["9w8YQ","bNKaB"], "bNKaB", "parcelRequire94c2")
